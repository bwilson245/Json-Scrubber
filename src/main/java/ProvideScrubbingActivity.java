...
public class ProvideScrubbingActivity implements RequestHandler<ScrubRequest, Object> {

    public ProvideScrubbingActivity(){}
    ...
    public Object handleRequest(ScrubRequest input, Context context) {
        try {
            if (input.getJsonElement().toString().length() > 25000000) {
                return new Gson().fromJson(new ScrubberAsync(input).scrub(), Object.class);
            } else {
                return new Gson().fromJson(new ScrubberNoAsync(input).scrub(), Object.class);
            }
    ...
    public static void main(String[] args) throws Exception {
        ...
        ProvideScrubbingActivity provider = new ProvideScrubbingActivity();
